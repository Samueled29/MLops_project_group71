...
@pytest.mark.skipif(not os.path.exists(_PATH_RAW_DATA), reason="Data files not found")
...
def test_create_tensor_datasets():
    ...
    assert isinstance(train_set, torch.utils.data.Dataset), "train_set should be an instance of torch.utils.data.Dataset"
